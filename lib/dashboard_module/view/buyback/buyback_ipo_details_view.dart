...
import 'package:ipodaily/dashboard_module/controller/buyback/buyback_ipo_details_controller.dart';
import 'package:ipodaily/dashboard_module/modal/buyback/buyback_details_model.dart';
...
import 'package:ipodaily/utilities/packages/read_more.dart';
...
class _BuybackIpoDetailsViewState extends State<BuybackIpoDetailsView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _buybackIpoDetailsController.obx(
        (state) {
          final data = [
            KeyValuePairModel(
              key: "Record Date",
