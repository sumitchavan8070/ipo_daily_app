...
import 'package:ipodaily/utilities/firebase/crashlytics_service.dart';
import 'package:ipodaily/utilities/firebase/notification_service.dart';
import 'package:ipodaily/utilities/navigation/go_paths.dart';
import 'package:ipodaily/utilities/navigation/navigator.dart';
import 'package:ipodaily/utilities/navigation/route_generator.dart';
  ...
  if (Platform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyAKlmfuabuYaET8N1az7TYs373g-XCWP-c",
        appId: "1:460867624360:android:c88eba6b2d3dbcb116519d",
        messagingSenderId: "460867624360",
        projectId: "ipo-app-39c4e",
      ),
    );
  }
  if (Platform.isIOS) {
